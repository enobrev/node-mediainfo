...
var MediaInfo = function(sFileName, fError, fComplete) {
    this.oInfo     = {};
    this.fError    = typeof fError    == 'function' ? fError    : function() {};
    this.fComplete = typeof fComplete == 'function' ? fComplete : function() {};
    ...
    this.onError = function(iCode) {
        this.fError('MediaInfo Error ' + iCode);
    }
